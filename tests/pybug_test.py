...
def test_ctcl_ahoy_special_char_inline():
    '''
    Unit test to check for detection and handling of special characters
    represented within braces embedded inline with other characters.
    '''
...
def test_ctcl_ahoy_special_chars():
    '''
    Unit test to check for detection and accuracy of all Ahoy special characters
    represented within braces.
    '''
...
def test_ctcl_detect_leading_closing_brace():
    '''
    Unit test to check for detection and error reporting of leading closing
    brace character "}" - a condition that should never happen in properly 
    typed in code.
    '''
